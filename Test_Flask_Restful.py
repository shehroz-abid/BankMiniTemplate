...
@app.route('/todo/api/v1.0/users/index')
def success():
    if 'username' in session:
...
@app.route('/todo/api/v1.0/users/<string:username>', methods=['POST'])
def sign_in_user():
...
@app.route('/todo/api/v1.0/users/<string:password>', methods=['POST', 'GET'])
def update_password():
...
@app.route('/todo/api/v1.0/users/<int:amount>', methods=['PUT'])
def update_amount(amount):
        try:
            ...
            cursor.execute(sp_update_amount, (new_amount, "shehroz.abid"))
            conn.commit()
...
@app.route('/todo/api/v1.0/users/<string:delt_username>', methods=['DELETE'])
def delete_user(delt_username):
    try:
        ...
        cursor.execute(sp_check_admin, "shehroz.abid")
